...
function custom_hello_theme_mods_styles() {
	...
	$disable_themes_global = get_theme_mod('htc_themestyles_gl_setting', 'no');
	$disable_themes_gravity = get_theme_mod('htc_themestyles_gf_setting', 'no');

	echo '<style type="text/css">';

	if( $disable_themes_global == 'no' ) {
		...
		$phead_fontfamily_format = ($phead_fontfamily == 'inherit') ? 'inherit' : '"' . $phead_fontfamily . '"'; 
		...
		printf( ".page-header .entry-title{font-size: %s%s;color: %s;font-family: %s;}\n", $phead_fontsize, $phead_fonttype, $phead_fontcolor, $phead_fontfamily_format );
	...
	if( $disable_themes_gravity == 'no' ) {
		...
		$gform_fontfamily_format = ($gform_fontfamily == 'inherit') ? 'inherit' : '"'. $gform_fontfamily .'"';
