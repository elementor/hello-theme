...
function hello_elementor_fail_load_admin_notice() {
	...
	if ( $is_elementor_installed ) {
		...
		$message = __( 'The Hello Theme is a lightweight starter theme that works perfectly with the Elementor award-winning page builder plugin. Once you activate the plugin, you are only 1 click away from building an amazing website.', 'hello-elementor' );
		...
		$message = __( 'The Hello Theme is a lightweight starter theme that works perfectly with the Elementor award-winning page builder plugin. Once you download and activate the plugin, you are only 1 click away from building an amazing website.', 'hello-elementor' );
	...
	<div class="notice updated is-dismissible hello-elementor-notice hello-elementor-install-elementor">
		...
		<div class="hello-elementor-notice-inner">
			<div class="hello-elementor-notice-content">
				<h3><?php esc_html_e( 'Thanks for installing the Hello Theme!', 'hello-elementor' ); ?></h3>
				<p><?php echo esc_html( $message ); ?></p>
				<a href="https://go.elementor.com/hello-theme-learn/" target="_blank"><?php esc_html_e( 'Explore Elementor Page Builder Plugin', 'hello-elementor' ); ?></a>
