...
export const LinkWithIconAndTitle = ({ title, link = null, icon = 'SettingsIcon', sublinks = [], onClick = () => {}, target = '' }) => {
	return (
		<Stack direction="row" gap={1} sx={{ alignContent: 'flex-start' }}>
			...
			<Stack direction="column">
				<LinkOrTitle title={title} link={link} icon={icon} sublinks={sublinks} onClick={onClick} target={target} />
