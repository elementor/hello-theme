			...
			<Paper elevation={1} sx={{ px: 4, py: 3, maxWidth: 750 }}>
				<Box sx={{ width: '100%' }}>
					...
					<Typography variant="body2" component="div" sx={{ mb: 4 }}>
						{__(
							"Advanced settings are available for experienced users and developers. If you're unsure about a setting, we recommend keeping the default option.",
							'hello-elementor',
						)}
					</Typography>
					<Box>
					...
					<TabPanel {...getTabPanelProps('two')}>
						<Structure />
					</TabPanel>
					<TabPanel {...getTabPanelProps('three')}>
						<Theme />
					</TabPanel>
				</Box>
			</Paper>
